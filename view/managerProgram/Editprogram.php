            ...
            <form action="../../control/program/EditCos.php" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        ...
                        value="<?php echo $result['Cos_code'];?>"  pattern="^[0-9].{4}"title="Must contain 5 numbers" required autofocus>
                    </div>
                </div>
                <!-- ชื่อแผนการเรียน  -->
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        ...
                        value="<?php echo $result['Cos_name'];?>" pattern="^[0-9a-zA-Zก-ฮ].{2,50}"title="Must contain at least 2 characters to 50 characters" required autofocus>
                    </div>
                </div>
