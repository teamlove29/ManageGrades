            ...
            <form id="myform" name='myform' method="POST" action="../../control/personnal/EditPersonal.php">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        ...
                        pattern="[0-9].{0,4}" title="Must be only 5 numbers " required autofocus></div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        ...
                        pattern="^[a-zA-Zก-ฮ\s].{0,50}" title="Must be only letters " required autofocus></div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        ...
                        pattern="^[0-9].{12}" title="Must be only 13 numbers " required autofocus></div>
                </div>
                                <!-- วันเกิด -->
                                <div class="form-group row">
